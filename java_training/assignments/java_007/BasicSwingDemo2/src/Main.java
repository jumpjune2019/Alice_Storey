...
public class Main {
	...
	interface SetFrameStuff {
		JFrame run(JFrame frm, int onExit, String label);
	}
	public static final CenterAndSizeJFrameOnScreen centerAndSizeJFrameOnScreen = (JFrame frm) -> {
	    /*
	...
	public static final SetFrameStuff setFrameStuff = (JFrame frm, int onExit, String label) -> {
		// this will center and size the JFrame on screen
		// it will have a height and width of half the screen
		centerAndSizeJFrameOnScreen.run(frm);
	...
	public static void main(String args[]) {
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				...
				frm = demo.getFrame();
				frm = setFrameStuff.run(frm, JFrame.EXIT_ON_CLOSE, "My label in a centered JFrame");
				frm.setVisible(true);
			}
		});
	}

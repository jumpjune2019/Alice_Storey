...
public class Main {
	...
	public static JFrame setFrameStuff(JFrame frm, int onExit, int width, int height, ButtonFlip bd) {
		...
		//bd = new ButtonFlip();
		bd.setButtons(panel1, "Click to (F)lip!", "(R)eset", "waiting...");
	...
	public static void main(String[] args) {
		...
		*/
		...
		SwingUtilities.invokeLater(new Runnable() {
			...
			public void run() {
				app = new CoinFlipFrame("Flip a Coin");
				frm = app.getFrame();
